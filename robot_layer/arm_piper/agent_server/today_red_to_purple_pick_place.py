...
def move_pick_place(args: argparse.Namespace, red: Detection, purple: Detection) -> None:
    ...
    robot.set_gripper(args.gripper_open, max_velocity=speed, max_acceleration=accel)
    ...
    robot.set_gripper(args.gripper_closed, max_velocity=speed, max_acceleration=accel)
    print("Lifting")
    robot.move_to_pose(pre_pick.tolist() + orientation, max_velocity=speed, max_acceleration=accel)
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--gripper-closed", type=float, default=0.006)
